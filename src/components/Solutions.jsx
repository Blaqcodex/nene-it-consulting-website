...
import { Zap, Cloud, Code2, Workflow } from "lucide-react";
          ...
          {solutions.map((solution) => {
            ...
            return (
              <motion.div
                ...
                className="group relative bg-white/5 backdrop-blur-xl border-white/10 rounded-3xl p-8 transition-all duration-500 hover:border-white/20 overflow-hidden"
              >
                {/* Hover glow */}
